"""Scipy's map_coordinates function, but with bicubic interpolation.

Adapted from https://github.com/LouisDesdoigts/jax/blob/cubic_splines/jax/_src/scipy/ndimage.py.
"""
import abc
import functools
import itertools
