...
def make_transformation_inference_train_and_eval(
    config, model: TransformationInferenceNet
):
    ...
    def loss_fn(
        ...
        loss = (
            config.x_mse_loss_mult * x_mse + state.η_loss_mult * η_recon_loss
