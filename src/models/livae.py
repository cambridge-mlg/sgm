...
# from src.transformations.affine import affine_transform_image
...
#         p_X_given_xhat_η = distrax.Normal(affine_transform_image(xhat, η), 1.0)
...
#         x = affine_transform_image(xhat, η)
#         return x
...
#         x_recon = affine_transform_image(xhat, η)
#         return x_recon
