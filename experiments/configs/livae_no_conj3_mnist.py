...
def get_config(angle) -> config_dict.ConfigDict:
    ...
    # Model config
    config.model_name = "LIVAE_NO_CONJ3"
    ...
    # p(η|Z) config
    config.model.Eta = config_dict.ConfigDict()
    config.model.Eta.base = config_dict.ConfigDict()
    config.model.Eta.base.hidden_dims = [64, 32]
    config.model.Eta.bijector = config_dict.ConfigDict()
    config.model.Eta.bijector.num_layers = 2
    config.model.Eta.bijector.num_bins = 4
    config.model.Eta.bijector.hidden_dims = [64, 32]
    # p(η|X) config
    ...
    config.model.Eta_given_X.bijector = config.model.Eta.bijector
