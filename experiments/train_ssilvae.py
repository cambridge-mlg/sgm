...
flags.DEFINE_integer("num_train", 50000, "Number of training examples.")
flags.DEFINE_integer("train_steps", 7501, "Number of training steps.")
...
def main(argv):
    ...
    ssilvae_config = get_ssilvae_config(f"{FLAGS.angle},{FLAGS.num_train},{FLAGS.train_steps},1")
    ssilvae_config.seed = FLAGS.seed
    vae_config = get_vae_config(f"{FLAGS.angle},{FLAGS.num_train},{FLAGS.train_steps}")
